            ...
            <div class="col-md-12">
                <table class="table table-bordered table-hover table-striped">
                    <tbody>
                        <tr>
                            <th colspan="3">
                                <a href="{{ route('awaiting') }}" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-arrow-circle-left"></i>&nbsp; Back</a>
                            </th>
                        </tr>
                        <tr>
                            <th>Status</th>
                            <th>
                                <td>
                                    ...
                                    <small class="text-primary"><i class="fa fa-clock-o"></i>&nbsp;Awaiting Verification</small>
                                    @endif
                                </td>
                            </th>
                        </tr>
