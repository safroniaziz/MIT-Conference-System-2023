            ...
            <div class="container z-10">
                <div class="flex   ">
                        ...
                        <div
                            ...
                            <div class=" pb-0 mb- bg-transparent border-b-0 rounded-t-2xl w-full text-center ">
                                <h3
                                    ...
                                    LOGIN HERE <br> OCERI SUBMISSION SYSTEM</h3>
                                <img src="{{ asset('assets/img/oceri.svg') }}" class="h-28 mx-auto mb-1" alt="logo">
                            </div>
                                ...
                                <form role="form" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="inline-block w-full px-6 py-3 mt-6 mb-0 font-bold text-center
                                            ...
                                            <p>Don't have an account? <a href="{{ route('register') }}" class="custom-link">Register Here</a></p>
                                    </div>
                                </form>
                            </div>
                            <div class=" pb-0 mb- bg-transparent border-b-0 rounded-t-2xl w-full text-center ">
                                <img src="{{ asset('assets/img/gomit.svg') }}" class="h-12 mx-auto mb-1" alt="logo">
                                <h4
                                    class="mb-4   z-10  text-transparent bg-gradient-to-tl from-black to-blue-500 font-bold  bg-clip-text">
                                    SUPPORT BY MIT CONFERENCE SYSTEM <br>CV.MEDIA INTI TEKNOLOGI</h4>
                            </div>
                        </div>
                    </div>
                    <div class="w-full   lg:flex-0 shrink-0 md:w-2/3  ">
                        ...
                        <lottie-player src="{{ asset('assets/img/animation-login.json') }}" background="transparent" speed="1" class="w-11/12 h-11/12 ml-20"
